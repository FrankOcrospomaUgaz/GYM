...
Route::middleware('auth')->group(function (): void {
    ...
    Route::prefix('api/gym')->group(function (): void {
        ...
        Route::get('memberships/{membership}', [GymController::class, 'showMembership']);
        Route::put('memberships/{membership}', [GymController::class, 'updateMembership']);
        Route::delete('memberships/{membership}', [GymController::class, 'destroyMembership']);
        ...
        Route::get('products/next-code', [GymController::class, 'nextProductCode']);
        ...
        Route::put('saas/users/{user}', [GymController::class, 'updateTenantUser']);
        Route::post('saas/branches', [GymController::class, 'storeBranch']);
        Route::put('saas/branches/{branch}', [GymController::class, 'updateBranch']);
    });
